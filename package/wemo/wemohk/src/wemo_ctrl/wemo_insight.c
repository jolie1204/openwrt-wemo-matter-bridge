...
int wemoCtrlGetInsightHomeSettings(int wemo_id)
{
    ...
    APP_LOG("WEMOHK", LOG_INFO, "Sending GetInsightHomeSettings...");
...
int wemoCtrlSetInsightHomeSettings(int wemo_id, struct we_insight_home_settings *settings)
{
    ...
    APP_LOG("WEMOHK", LOG_INFO, "Sending SetInsightHomeSettings...");
    ret = wemoCtrlPointSendAction(WEMO_SERVICE_BASICEVENT,
                                  wemo_id,
...
int wemoCtrlGetInsightParams(int wemo_id)
{
    ...
    APP_LOG("WEMOHK", LOG_INFO, "Sending GetInsightParams...");
...
int wemoCtrlSetPowerThreshold(int wemo_id, struct we_insight_threshold *threshold)
{
    ...
    value[0] = (char *)malloc(sizeof(int) + 1);
    if (value[0] == NULL) {
        return -1;
    }
    snprintf(value[0], sizeof(int) + 1, "%s", threshold->threshold);

    APP_LOG("WEMOHK", LOG_INFO, "Sending SetPowerThreshold...");
    ret = wemoCtrlPointSendAction(WEMO_SERVICE_INSIGHT,
                                  wemo_id,
                                  "SetPowerThreshold",
                                  (char **) params,
...
int wemoCtrlGetPowerThreshold(int wemo_id)
{
    ...
    APP_LOG("WEMOHK", LOG_INFO, "Sending getPowerThreshold...");
    ret = wemoCtrlPointSendAction(WEMO_SERVICE_INSIGHT,
                                  wemo_id,
                                  "GetPowerThreshold",
                                  NULL,
...
int wemoCtrlGetDataExportInfo(int wemo_id)
{
    ...
    APP_LOG("WEMOHK", LOG_INFO, "Sending getDataExportInfo...");
    ret = wemoCtrlPointSendAction(WEMO_SERVICE_INSIGHT,
                                  wemo_id,
                                  "GetDataExportInfo",
                                  NULL,
...
int wemoCtrlScheduleDataExport(int wemo_id, struct we_insight_export *export)
{
    ...
    APP_LOG("WEMOHK", LOG_INFO, "Sending ScheduleDataExport... %s : %s", value[0], value[1]);
    ret = wemoCtrlPointSendAction(WEMO_SERVICE_INSIGHT,
                                  wemo_id,
                                  "ScheduleDataExport",
                                  (char **) params,
